...
(
    id_expense      NUMBER(5) GENERATED BY DEFAULT ON NULL AS IDENTITY,
    id_expense_category NUMBER(5),
    vl_expense_value    NUMBER(9, 2),
    ds_expense_note     VARCHAR2(255),
    id_user             NUMBER(5),
    dt_transaction      DATE,
    CONSTRAINT t_expense_pk PRIMARY KEY (id_expense),
    CONSTRAINT fk_user_expense FOREIGN KEY (id_user)
        REFERENCES t_user (id_user),
...
(
    id_investment         NUMBER(5) GENERATED BY DEFAULT ON NULL AS IDENTITY,
    vl_invested            NUMBER(9, 2),
    ds_investment          VARCHAR2(255),
    id_investment_category NUMBER(5),
    id_user                NUMBER(5),
    dt_transaction         DATE,
    CONSTRAINT t_investment_pk PRIMARY KEY (id_investment),
    CONSTRAINT fk_user_investment FOREIGN KEY (id_user)
        REFERENCES t_user (id_user),
...
(
    id_revenue      NUMBER(5) GENERATED BY DEFAULT ON NULL AS IDENTITY,
    id_revenue_category NUMBER(5),
    id_user             NUMBER(5),
    vl_revenue          NUMBER(9, 2),
    ds_revenue          VARCHAR2(255),
    dt_transaction      DATE,
    CONSTRAINT t_revenue_pk PRIMARY KEY (id_revenue),
    CONSTRAINT fk_user_revenue FOREIGN KEY (id_user)
        REFERENCES t_user (id_user),
